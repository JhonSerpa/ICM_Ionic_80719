...
@Component({
    selector: 'page-jantarEs',
    templateUrl: 'jantarEs.html'
  })
  export class JantarEsPage {
            ...
            .subscribe(text => {
                ...
                this._robotOverlords= text;
                    for (var i = 0; i< text.menus.menu.length; i++){
                        try{
                            if(text.menus.menu[i]['@attributes'].meal == "Jantar" && text.menus.menu[i]['@attributes'].canteen == "Refeitório ESTGA"){
