...
@Component({
    selector: 'page-almocoSa',
    templateUrl: 'almocoSa.html'
  })
  export class AlmocoSaPage {
            ...
            .subscribe(text => {
                ...
                this._robotOverlords= text;
                    for (var i = 0; i< text.menus.menu.length; i++){
                        try{
                            if(text.menus.menu[i]['@attributes'].meal == "Almoço" && text.menus.menu[i]['@attributes'].canteen == "Refeitório de Santiago"){
